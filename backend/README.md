...
## Project Structure
    ...
    ├── testapiautocatalog_120328  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_120328`
...
2. Clone this repo and `cd testapiautocatalog_120328`
